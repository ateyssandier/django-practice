...
function drawChart(gross_array, net_array) {
    //gross_array
    /*[
        ['Car', 113.61 ],
        ['Clothing', 66.70 ],
    ...
    netData.addRows(net_array);
    // Set chart options
    var options2 = {'title':'Net Paychcheck BreakDown','width':600, 'height':450};
